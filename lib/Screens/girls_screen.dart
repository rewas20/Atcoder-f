      ...
      children: [
        Scaffold(
          appBar: AppBar(
            ...
            title: Text(listAllGirls==null||listAllGirls.isEmpty?name:"$name (${listAllGirls.length})",style: const TextStyle(fontSize: 18,fontWeight: FontWeight.bold)),
          ),
          body: StreamBuilder(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_,index){
                    return Card(
                      ...
                      child: NameItem(id: listAllGirls[index].id,name: listAllGirls[index].name, gender: listAllGirls[index].gender, typeUser: listAllGirls[index].typeUser, deleteItem: (id) async {
