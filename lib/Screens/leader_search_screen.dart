...
class SearchScreen extends StatefulWidget {
  List<LeaderModel> listLeaders;
  SearchScreen(this.listLeaders);
      ...
      child:  Material(
        ...
        child: Container(
          ...
          child: TextFormField(
            ...
            onChanged: (String){
              setState(() {
                result = widget.listLeaders.where((element) =>
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(onPressed: () async {
                      ...
                      await DatabaseProvider.instance.deleteLeader(result[index].id!);
                      setState((){
